...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "language": "c++",
        "name": "annotat3d.cython.__init__",
        "sources": [
            "annotat3d/cython/__init__.py"
        ]
    },
    "module_name": "annotat3d.cython.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__annotat3d__cython____init__
#define __PYX_HAVE_API__annotat3d__cython____init__
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'annotat3d.cython.__init__' */
#define __Pyx_MODULE_NAME "annotat3d.cython.__init__"
extern int __pyx_module_is_main_annotat3d__cython____init__;
int __pyx_module_is_main_annotat3d__cython____init__ = 0;

/* Implementation of 'annotat3d.cython.__init__' */
...
static PyObject *__pyx_n_u_cython;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_u_cython, __pyx_k_cython, sizeof(__pyx_k_cython), 0, 1, 0, 1},
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_annotat3d__cython____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely(__Pyx_SetPackagePathFromImportLib("annotat3d", __pyx_n_u_cython) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "annotat3d.cython")) {
      if (unlikely(PyDict_SetItemString(modules, "annotat3d.cython", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "annotat3d/cython/__init__.py":1
 ...
 */
  ...
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_annotation, __pyx_t_1, 1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 1, __pyx_L1_error)
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init annotat3d.cython.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init annotat3d.cython.__init__");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
