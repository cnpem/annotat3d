...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "language": "c++",
        "name": "annotat3d.cython.annotation",
        "sources": [
            "annotat3d/cython/annotation.pyx"
        ]
    },
    "module_name": "annotat3d.cython.annotation"
}
END: Cython Metadata */
...
#define __PYX_HAVE__annotat3d__cython__annotation
#define __PYX_HAVE_API__annotat3d__cython__annotation
/* Early includes */
#include <algorithm>
#include "ios"
#include "new"
...
/* Module declarations from 'annotat3d.cython.annotation' */
...
static PyObject *__pyx_f_9annotat3d_6cython_10annotation_superpixel_majority_voting(PyObject *, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "annotat3d.cython.annotation"
extern int __pyx_module_is_main_annotat3d__cython__annotation;
int __pyx_module_is_main_annotat3d__cython__annotation = 0;

/* Implementation of 'annotat3d.cython.annotation' */
...
static PyObject *__pyx_pf_9annotat3d_6cython_10annotation_superpixel_majority_voting(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_annotation_dict, __Pyx_memviewslice __pyx_v_superpixels); /* proto */
...
/* "annotat3d/cython/annotation.pyx":15
...
static PyObject *__pyx_pw_9annotat3d_6cython_10annotation_1superpixel_majority_voting(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_9annotat3d_6cython_10annotation_superpixel_majority_voting(PyObject *__pyx_v_annotation_dict, __Pyx_memviewslice __pyx_v_superpixels, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_coord_x;
  int __pyx_v_coord_y;
  int __pyx_v_coord_z;
  int __pyx_v_label;
  ...
  /* "annotat3d/cython/annotation.pyx":25
 ...
 */
  ...
  while (1) {
    ...
    /* "annotat3d/cython/annotation.pyx":26
 *     # st = time.time()
 *     for (coord_x, coord_y, coord_z), (label, mk_id) in annotation_dict.items():
 *         superpixel_id = superpixels[coord_x, coord_y, coord_z]             # <<<<<<<<<<<<<<
 *         # # Ensuring that 0-valued superpixels are disconsidered due to old bug that was fixed Nvidia Tesla K80. That bug was fixed.
 ...
 */
    ...
    /* "annotat3d/cython/annotation.pyx":28
 *         superpixel_id = superpixels[coord_x, coord_y, coord_z]
 *         # # Ensuring that 0-valued superpixels are disconsidered due to old bug that was fixed Nvidia Tesla K80. That bug was fixed.
 *         if superpixel_id > 0:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (__pyx_t_18) {
      ...
      /* "annotat3d/cython/annotation.pyx":29
 *         # # Ensuring that 0-valued superpixels are disconsidered due to old bug that was fixed Nvidia Tesla K80. That bug was fixed.
 *         if superpixel_id > 0:
 *             preincrement(superpixel_marker_labels[superpixel_id][label])             # <<<<<<<<<<<<<<
 *     # en = time.time()
 ...
 */
  ...
  /* "annotat3d/cython/annotation.pyx":33
 *     # print('dict iteration time: ', en-st)
 * 
 ...
 */
  ...
  /* "annotat3d/cython/annotation.pyx":34
 * 
 *     cdef cunmap[int, cunmap[int, int]].iterator end = superpixel_marker_labels.end()
 *     cdef cunmap[int, cunmap[int, int]].iterator it = superpixel_marker_labels.begin()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "annotat3d/cython/annotation.pyx":36
 *     cdef cunmap[int, cunmap[int, int]].iterator it = superpixel_marker_labels.begin()
 * 
 *     superpixel_marker_labels_dict = {}             # <<<<<<<<<<<<<<
 *     # st = time.time()
 ...
 */
  ...
  /* "annotat3d/cython/annotation.pyx":38
 *     superpixel_marker_labels_dict = {}
 *     # st = time.time()
 *     while it != end:             # <<<<<<<<<<<<<<
 ...
 */
  while (1) {
    ...
    /* "annotat3d/cython/annotation.pyx":40
 *     while it != end:
 *         #superpixel_id = it->first
 *         superpixel_id = dereference(it).first             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "annotat3d/cython/annotation.pyx":42
 *         superpixel_id = dereference(it).first
 *         # label = max_element(it->second.begin(), it->second.end())->first
 *         label = dereference( max_element(dereference(it).second.begin(), dereference(it).second.end()) ).first             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "annotat3d/cython/annotation.pyx":43
 *         # label = max_element(it->second.begin(), it->second.end())->first
 *         label = dereference( max_element(dereference(it).second.begin(), dereference(it).second.end()) ).first
 *         superpixel_marker_labels_dict[superpixel_id] = label             # <<<<<<<<<<<<<<
 *         preincrement(it)#++it
 ...
 */
    ...
    /* "annotat3d/cython/annotation.pyx":44
 *         label = dereference( max_element(dereference(it).second.begin(), dereference(it).second.end()) ).first
 *         superpixel_marker_labels_dict[superpixel_id] = label
 *         preincrement(it)#++it             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "annotat3d/cython/annotation.pyx":50
 *     # en = time.time()
 ...
 */
  ...
  __Pyx_AddTraceback("annotat3d.cython.annotation.superpixel_majority_voting", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_9annotat3d_6cython_10annotation_1superpixel_majority_voting(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_9annotat3d_6cython_10annotation_1superpixel_majority_voting(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_r = __pyx_pf_9annotat3d_6cython_10annotation_superpixel_majority_voting(__pyx_self, __pyx_v_annotation_dict, __pyx_v_superpixels);
...
static PyObject *__pyx_pf_9annotat3d_6cython_10annotation_superpixel_majority_voting(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_annotation_dict, __Pyx_memviewslice __pyx_v_superpixels) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __pyx_t_1 = __pyx_f_9annotat3d_6cython_10annotation_superpixel_majority_voting(__pyx_v_annotation_dict, __pyx_v_superpixels, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "annotat3d.cython.annotation.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "annotat3d.cython.annotation.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "annotat3d.cython.annotation.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "annotat3d.cython.annotation._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"superpixel_majority_voting", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9annotat3d_6cython_10annotation_1superpixel_majority_voting, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_annotat3d__cython__annotation) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "annotat3d.cython.annotation")) {
      if (unlikely(PyDict_SetItemString(modules, "annotat3d.cython.annotation", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "annotat3d/cython/annotation.pyx":4
 ...
 */
  ...
  /* "annotat3d/cython/annotation.pyx":9
 ...
 */
  ...
  /* "annotat3d/cython/annotation.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init annotat3d.cython.annotation", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init annotat3d.cython.annotation");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
