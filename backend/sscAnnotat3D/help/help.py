...
class widget_help(QDialog):
    def __init__(self, parent=None):
        super(widget_help, self).__init__()
        # 		self.setModal(True)

        self.setWindowFlags(Qt.WindowMinimizeButtonHint | Qt.WindowCloseButtonHint | Qt.WA_DeleteOnClose)

        file_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "ui", "help", "help.md.html"))
        ...
        if __has_webengine__:
            ...
            file_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "help.md.html"))
