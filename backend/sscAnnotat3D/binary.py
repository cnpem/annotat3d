...
def precision(result, reference):
    ...
    References
    ----------
    .. [wiki-precision-recall] http://en.wikipedia.org/wiki/Precision_and_recall
    """
    result = numpy.atleast_1d(result.astype(numpy.bool))
    reference = numpy.atleast_1d(reference.astype(numpy.bool))
...
def specificity(result, reference):
    ...
    References
    ----------
    .. [wiki-sensitivity] https://en.wikipedia.org/wiki/Sensitivity_and_specificity
    .. [wiki-confusion-matrix] http://en.wikipedia.org/wiki/Confusion_matrix#Table_of_confusion
    """
    result = numpy.atleast_1d(result.astype(numpy.bool))
    reference = numpy.atleast_1d(reference.astype(numpy.bool))
