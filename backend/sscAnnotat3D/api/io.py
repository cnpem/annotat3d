...
def _augmenters_list(augmentation_vec: list = None, ion_range_vec: list = None):
    ...
    if augmentation_vec[4]["isChecked"]:
        ...
        augmenters.append(dict(type="contrast", contrast=(c_lower, c_upper)))
    ...
    if augmentation_vec[5]["isChecked"]:
        ...
        augmenters.append(dict(type="linear-contrast", linearContrast=(c_lower, c_upper)))
    ...
    if augmentation_vec[6]["isChecked"]:
        ...
        augmenters.append(dict(type="dropout", dropout=(c_lower, c_upper)))
    ...
    if augmentation_vec[7]["isChecked"]:
        ...
        augmenters.append(dict(type="gaussian-blur", sigma=(c_lower, c_upper)))
    ...
    if augmentation_vec[8]["isChecked"]:
        ...
        augmenters.append(dict(type="average-blur", k=(c_lower, c_upper)))
    ...
    if augmentation_vec[9]["isChecked"]:
        ...
        augmenters.append(dict(type="additive-poisson-noise", k=(c_lower, c_upper)))
    ...
    if augmentation_vec[10]["isChecked"]:
        ...
        augmenters.append(
            dict(type="elastic-deformation", alpha=(c_lower_alpha, c_upper_alpha), sigma=(c_lower_sigma, c_upper_sigma))
        )
...
def create_dataset():
    ...
    data, error_status = create_dataset_web(imgs, labels, weights, output, nsamples, num_classes, size, offset)
