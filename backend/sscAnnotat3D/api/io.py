...
# this functions are being removed from the io.py file and placed together with the other functions from the deep learning system in 
# the api/deep.py file to ease the code maintanance
