...
const AddNewFile: React.FC<AddNewFileInterface> = ({
    ...
    const readFile = () => {
        ...
        sfetch(
            'POST',
            `/open_files_dataset/${typeOperation.toLowerCase()}-${pathFiles.id}`,
            ...
            <IonAccordionGroup multiple={true}>
                ...
                <IonAccordion>
                    <IonItem slot={'header'}>
                        ...
                        <IonLabel>
                            <small>Load {typeOperation} workspace</small>
                        </IonLabel>
                    </IonItem>
                ...
                <IonAccordion>
                    <IonItem slot={'header'}>
                        ...
                        <IonLabel>
                            <small>Load {typeOperation}</small>
                        </IonLabel>
                    </IonItem>
                    <IonList slot={'content'}>
                        <IonItem>
    ...
    return (
        <Fragment>
            <IonAlert
                ...
                buttons={[
                    ...
                    },
                    {
                        ...
                        handler: () => {
                            setShowLoadingComp(true);
                            sfetch('POST', `/close_all_files_dataset/${typeOperation.toLowerCase()}`)
                                .then(() => {
            ...
            <ErrorWindowComp
                ...
                onErrorFlag={handleErrorWindow}
            />
            <DeepLoadingComp openLoadingWindow={showLoadingComp} loadingText={`Deleting all ${typeOperation}`} />
        </Fragment>
    );
};
                    ...
                    buttons={[
                        ...
                        },
                        {
                            ...
                            handler: () => {
                                ...
                                sfetch(
                                    'POST',
                                    `/close_files_dataset/${labelElement.typeOperation.toLowerCase()}-${
                                        labelElement.id
                                    }`,
                                    'json'
                                )
 ...
 * @constructor
 */
const SamplingComp: React.FC<SamplingCompInterface> = ({
    sampleElement,
    onSampling,
    workspacePath,
    onWorkspacePath,
    ...
    const renderLabel = (labelElement: TableInterface) => {
        ...
        return (
            ...
            >
                {/*Table Content*/}
                <td>
                    <FileNameComp labelElement={labelElement} removeLabelElement={removeLabelElement} />
                </td>
                <td>
            ...
            <IonContent scrollEvents={true}>
                ...
                <IonAccordionGroup multiple={true}>
                    ...
                    <IonAccordion>
                        ...
                        <IonList slot={'content'}>
                            <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                                <IonButton id={'data-menu'} size={'default'}>
                            ...
                            <div className={'label-table-dataset table-responsive text-nowrap'}>
                                ...
                                >
                                    ...
                                    <tbody>{dataTable.map(renderLabel)}</tbody>
                                </ReactBootStrap.Table>
                            </div>
                            <AddNewFile
                                idMenu={idTableData}
                    ...
                    <IonAccordion>
                        ...
                        <IonList slot={'content'}>
                            <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                                <IonButton id={'label-menu'} size={'default'}>
                                    <IonIcon icon={addOutline} slot={'end'} />
                                    Add
                                </IonButton>
                                <IonButton
                            ...
                            <div className={'label-table-dataset table-responsive text-nowrap'}>
                                ...
                                >
                                    ...
                                    <tbody>{labelTable.map(renderLabel)}</tbody>
                                </ReactBootStrap.Table>
                            </div>
                            <AddNewFile
                                idMenu={idTableLabel}
                    ...
                    <IonAccordion>
                        ...
                        <IonList slot={'content'}>
                            <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                                <IonButton id={'weight-menu'} size={'default'}>
                                    <IonIcon icon={addOutline} slot={'end'} />
                                    Add
                                </IonButton>
                                <IonButton
                            ...
                            <div className={'label-table-dataset table-responsive text-nowrap'}>
                                <ReactBootStrap.Table striped bordered hover className={darkMode ? 'table-dark' : ''}>
                                    ...
                                    <tbody>{weightTable.map(renderLabel)}</tbody>
                                </ReactBootStrap.Table>
                            </div>
                            <AddNewFile
                                    ...
                                    <IonCol>
                                        ...
                                        <div style={{ display: 'flex', justifyContent: 'flex-start' }}>
                                            <IonInput
                                                type={'number'}
                                                min={'0'}
                                                value={sampleElement.sampleSize}
                                                onIonChange={(e: CustomEvent) => {
                                                    onSampling({
                                                        ...sampleElement,
                                                ...
                                                onIonChange={(e: CustomEvent) =>
                                                    onSampling({
                                                        ...
                                                        patchSize: [
                                                            ...
                                                            sampleElement.patchSize[1],
                                                            sampleElement.patchSize[2],
                                                        ],
                                                    })
                                                }
                                            />
