...
const BatchInferenceComp: React.FC = () => {
    ...
    const [isInferenceOpChecked, setIsInferenceOpChecked] = useStorageState<boolean>(
        sessionStorage,
    ...
    return (
        <Fragment>
            ...
            <IonItem
                ...
                onClick={() => {
                    sfetch('POST', '/get_frozen_data', '', 'json')
                        .then((payload: SelectInterface[]) => {
                            console.log(payload);
            ...
            />
            <DeepLoadingComp openLoadingWindow={showLoadingComp} loadingText={'Doing the inference'} />
        </Fragment>
    );
};
