...
import ImageInfoInterface from "../file/ImageInfoInterface";
...
interface FileLoadDeepDialogInterface {
    header: string,
    textLoad: string
}
...
const FileLoadDeepDialog: React.FC<FileLoadDeepDialogInterface> = ({header,
                                                                       textLoad}) => {
