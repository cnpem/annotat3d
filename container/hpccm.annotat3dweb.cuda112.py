...
def main():
    ...
    stage += hpccm.primitives.baseimage(
        image="nvcr.io/nvidia/cuda:11.2.2-cudnn8-devel-ubuntu20.04", _distro=args.distro
    )
    ...
    stage += hpccm.building_blocks.conda(
        channels=["conda-forge", "nvidia"], prefix="/opt/conda", python_subversion="py39", version="24.3.0-0", eula=True
    )
